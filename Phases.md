...
| Date | Version | Change |
|---|---|---|
| 19 Aug 2026 | 1.25 | **A2.13.** Onboarding Care Circle gate names blocking fields; established CT WhatsApp/timezone seeded from `care_partners` without `?mode=additional`. Loved One Reports tab is an entry point to on-demand `/reports`. |
