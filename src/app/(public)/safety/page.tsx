    ...
    <>
      <MotionSection className="mx-auto max-w-6xl px-4 pb-10 pt-16 sm:px-6 sm:pt-20">
        <MotionItem>
          ...
          <SectionLead>
            SilaCares helps families coordinate when something feels urgent. It is not a replacement
          ...
          {[
            {
              ...
              text: "When an SOS is triggered, SilaCares notifies everyone in your Loved One’s Care Circle at once.",
            },
            {
              icon: Users,
            ...
            },
            {
              ...
              text: "In a real emergency, call local emergency services immediately. SilaCares supports family communication. It does not replace emergency services.",
            },
          ].map((item) => {
