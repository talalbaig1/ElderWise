...
const extraFaq = [
  {
    question: "Is ElderWise a medical device?",
    answer:
      "No. ElderWise supports family communication and routine monitoring. It does not provide medical diagnosis or replace professional care.",
  },
  {
    question: "What if my Loved One does not use WhatsApp?",
    answer:
      "ElderWise is built around WhatsApp-style check-ins because they feel familiar. Additional channels can be added later; WhatsApp remains the core experience today.",
  },
  {
...
export default function FaqPage() {
  return (
    <>
      ...
      <FinalCta
        title="Still wondering if ElderWise is right for your family?"
