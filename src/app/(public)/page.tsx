...
const featureBlocks = [
  ...
  },
  {
    ...
    text: "Escalate to the Care Partner, Local Buddy, and Family Doctor. ElderWise supports coordination — always contact local emergency services in a crisis.",
...
export default function HomePage() {
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
          <MotionItem>
            ...
            <SectionLead>
              Five simple steps — so you know exactly how ElderWise helps you care for someone you
              love.
            </SectionLead>
          </MotionItem>
      ...
      {/* Why families choose ElderWise */}
      <MotionSection className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
        <MotionItem>
          <SectionEyebrow>Why families choose ElderWise</SectionEyebrow>
      ...
      <MotionSection className="relative overflow-hidden border-y">
        ...
        <div className="relative mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
          <MotionItem>
            ...
            <SectionLead>
              Did they take their medicine? Did lunch happen? Is today a good day? ElderWise turns
        ...
        <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
          <MotionItem>
            ...
            <SectionLead className="text-white/75">
              ElderWise connects the people around your Loved One — with language that feels human
