    ...
    <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-foreground/90">
        <section className="space-y-2">
          ...
          <p>
            ElderWise is a <strong>non-commercial student capstone project</strong> by Group 7 of
        ...
        <section className="space-y-2">
          ...
          <p>
            ElderWise is built for coursework and demonstration. Please use test data. Do not
        ...
        <section className="space-y-2">
          ...
          <p>
            ElderWise does not provide medical advice, diagnosis, or treatment, and is not a
          ...
          <p>
            ...
            or delay professional medical advice because of something ElderWise showed you.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            confirming that they have agreed to receive WhatsApp messages from ElderWise. Do not
        ...
        <section className="space-y-2">
          ...
          <p>Do not store anything in ElderWise that you would be upset to lose.</p>
        </section>
