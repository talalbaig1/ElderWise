        ...
        <div className="space-y-4 rounded-2xl border bg-background/70 p-4">
          ...
          <label className="flex items-start gap-3 text-sm">
            ...
            <span className="leading-relaxed text-muted-foreground">
              <span className="font-medium text-foreground">
                I confirm {elderName} has agreed to receive SilaCares check-in messages on
                WhatsApp.
              </span>
          ...
          <label className="flex items-start gap-3 text-sm">
            ...
            <span className="leading-relaxed text-muted-foreground">
              ...
              <span className="mt-1 block text-xs">
                SilaCares does not provide medical advice or diagnosis — always consult a doctor.
              </span>
            </span>
          </label>
