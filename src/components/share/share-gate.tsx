...
export function ShareGate({ token }: { token: string }) {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-lg flex-col justify-center gap-6 px-6 py-16">
      <p className="font-display text-2xl tracking-tight text-foreground">SilaCares</p>
  ...
  return (
    <main className="mx-auto max-w-2xl space-y-10 px-6 py-12">
      ...
      <p className="border-t pt-6 font-mono text-[11px] text-muted-foreground">
        Read-only facts for clinical context. SilaCares does not diagnose or advise.
      </p>
    </main>
  );
}
