    ...
    return (
      ...
      >
        ...
        <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
          Thank you for joining the ElderWise waitlist. We’ll confirm by email and WhatsApp.
        </p>
      </div>
    );
  }
      ...
      <div className="space-y-2">
        <label className="flex items-start gap-3 text-sm text-muted-foreground">
          ...
          <span className="leading-relaxed">
            I agree to be contacted by ElderWise by email and WhatsApp about early access.
          </span>
        </label>
        {errors.consent ? (
